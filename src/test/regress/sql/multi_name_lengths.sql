...
SELECT qualified_shard_name(NULL, 666666);
SELECT qualified_shard_name(0, 666666);
SELECT qualified_shard_name('too_long_12345678901234567890123456789012345678901234567890'::regclass, 666666);
SELECT qualified_shard_name('too_long_12345678901234567890123456789012345678901234567890'::regclass, NULL);
SELECT qualified_shard_name('too_long_12345678901234567890123456789012345678901234567890'::regclass, -21);
...
SELECT qualified_shard_name(U&'elephant_!0441!043B!043E!043D!0441!043B!043E!043D!0441!043B!043E!043D!0441!043B!043E!043D!0441!043B!043E!043D!0441!043B!043E!043D' UESCAPE '!'::regclass, min(shardid))
FROM pg_dist_shard
WHERE logicalrelid = U&'elephant_!0441!043B!043E!043D!0441!043B!043E!043D!0441!043B!043E!043D!0441!043B!043E!043D!0441!043B!043E!043D!0441!043B!043E!043D' UESCAPE '!'::regclass;
...
-- Verify that qualified_shard_name UDF supports schemas
...
SELECT qualified_shard_name('multi_name_lengths.too_long_12345678901234567890123456789012345678901234567890'::regclass, min(shardid))
FROM pg_dist_shard
